"""Linear Regression pipeline for holdout validation with 2000 training and 1000 validation samples."""
...
def train_and_evaluate() -> dict:
    """Train Linear Regression model on holdout training set and evaluate on validation set."""
    # Load data

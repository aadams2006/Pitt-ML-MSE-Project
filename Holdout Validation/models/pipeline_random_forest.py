"""Random Forest Regression pipeline for holdout validation with 2000 training and 1000 validation samples."""
...
def train_and_evaluate() -> dict:
    """Train Random Forest model on holdout training set and evaluate on validation set."""
    # Load data
...
MSE: {metrics['MSE']:.4f}"""
    ...
    plt.tight_layout()
    output_path = output_dir / f"{model_name.replace(' ', '_')}_evaluation.png"

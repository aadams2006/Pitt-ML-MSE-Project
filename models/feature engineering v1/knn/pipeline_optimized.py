"""KNN pipeline with OPTIMIZED hyperparameters."""
...
def train_and_evaluate(X_train, X_test, y_train, y_test, model_name: str = "KNN") -> dict:
    """Train KNN model with OPTIMIZED hyperparameters and return evaluation metrics."""
    ...
    # - n_neighbors: 20 [was 5]
    # - weights: 'distance' [was 'uniform']
    # - p: 1 [was 2]
    # - metric: 'manhattan' [was 'euclidean']

"""Random Forest Regression pipeline with OPTIMIZED hyperparameters."""
...
def train_and_evaluate(X_train, X_test, y_train, y_test, model_name: str = "Random Forest Regression") -> dict:
    """Train Random Forest model with OPTIMIZED hyperparameters and return evaluation metrics."""
    ...
    # - max_depth: 15 [was None (unlimited)]
